...
def make_env(rank, seed=0):
    def _init():
        env = CleanTransitionEnv(target_lin_vel=(_CMD_START, 0.0), target_ang_vel=_CMD_ANG_VEL, use_tg=True, max_level=_MAX_LEVEL, obs_mode="A")
...
def train(cfg, run_name="clean_trans_noh", render_freq=500_000, live_viewer=False):
    preflight(cfg.gamma)
    ...
    model.save(os.path.join(checkpoint_dir, "clean_trans_noh_final"))
...
if __name__ == "__main__":
    ...
    p.add_argument("--run-name", type=str, default="clean_trans_noh")
