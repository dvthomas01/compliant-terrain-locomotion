...
def make_env(rank, seed=0):
    def _init():
        env = TransitionEnv(target_lin_vel=(_CMD_START, 0.0), target_ang_vel=_CMD_ANG_VEL, use_tg=True, max_level=_MAX_LEVEL)
...
def train(cfg, run_name="policy_b_trans", render_freq=500_000, live_viewer=False):
    preflight(cfg.gamma)
    ...
    model.save(os.path.join(checkpoint_dir, "policy_b_trans_final"))
...
if __name__ == "__main__":
    ...
    p.add_argument("--run-name", type=str, default="policy_b_trans")
